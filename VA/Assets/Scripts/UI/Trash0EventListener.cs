...
namespace OrdureX.UI
{
    ...
    public class Trash0EventListener : MonoBehaviour
    {
        [SerializeField]
        ...
        {
            m_Events.OnTrash0CollectRequested += OnCollectRequested;
            m_Events.OnTrash0InvalidCode += OnInvalidCode;
            m_Events.OnTrash0LidChanged += OnLidChanged;
        }
        ...
        {
            Debug.Log("Invalid code for trash 0: " + uuid.ToString());
